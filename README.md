...
- Folder Peek: instantly list everything inside a folder as a tree with honest type chips (cached audio verdicts included) and per-folder composition rollups; view-only, with HTML/CSV/JSON export
